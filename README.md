...
![Algoritmo Mensajes](docs/messageAlgorithm.png)
 ...
 - El valor de cada columna será una letra en el mensaje.

### Calculo de la Localización
...
## Covertura de Código del 90% 
![Cobertura de Código](docs/codeCoverage.png)  
...
### Notas:  
 ...
 - La implementación `SatelliteRepositoryInMemoryImpl` tiene estado,  lo que impide escalar horizontalmente la apliación ya que se pueden obtener resultados distintos si el request apunta a diferentes nodos. Se hubiese podido utilizar Redis.
